...
INSERT INTO `MEMBER` VALUES('a111','박지원','010-1234-10011','사원','105','2020-11-19 11:39:48');


# 부서 테이블 데이터 입력하기
INSERT INTO `DEPART` VALUES('101','영업2부','051-512-1001');
INSERT INTO `DEPART` VALUES('102','영업1부','051-512-1002');
...
# 매출 테이블 데이터 입력하기
INSERT INTO `SALE` VALUES('','a101','2018','1',98100);
INSERT INTO `SALE` VALUES('','a102','2018','1',136000);
INSERT INTO `SALE` VALUES('','a103','2018','1',80100);
INSERT INTO `SALE` VALUES('','a104','2018','1',78000);
INSERT INTO `SALE` VALUES('','a105','2018','1',93000);
INSERT INTO `SALE` VALUES('','a101','2018','2',23500);
INSERT INTO `SALE` VALUES('','a102','2018','2',126000);
INSERT INTO `SALE` VALUES('','a103','2018','2',18500);
INSERT INTO `SALE` VALUES('','a105','2018','2',19000);
INSERT INTO `SALE` VALUES('','a106','2018','2',53000);
INSERT INTO `SALE` VALUES('','a101','2019','1',24000);
INSERT INTO `SALE` VALUES('','a102','2019','1',109000);
INSERT INTO `SALE` VALUES('','a103','2019','1',101000);
INSERT INTO `SALE` VALUES('','a104','2019','1',53500);
INSERT INTO `SALE` VALUES('','a107','2019','1',24000);
INSERT INTO `SALE` VALUES('','a102','2019','2',160000);
INSERT INTO `SALE` VALUES('','a103','2019','2',101000);
INSERT INTO `SALE` VALUES('','a104','2019','2',43000);
INSERT INTO `SALE` VALUES('','a105','2019','2',24000);
INSERT INTO `SALE` VALUES('','a106','2019','2',109000);
INSERT INTO `SALE` VALUES('','a102','2020','1',201000);
INSERT INTO `SALE` VALUES('','a104','2020','1',63000);
INSERT INTO `SALE` VALUES('','a105','2020','1',74000);
INSERT INTO `SALE` VALUES('','a106','2020','1',122000);
INSERT INTO `SALE` VALUES('','a107','2020','1',111000);
INSERT INTO `SALE` VALUES('','a102','2020','2',120000);
INSERT INTO `SALE` VALUES('','a103','2020','2',93000);
INSERT INTO `SALE` VALUES('','a104','2020','2',84000);
INSERT INTO `SALE` VALUES('','a105','2020','2',180000);
INSERT INTO `SALE` VALUES('','a108','2020','2',76000);
...
SELECT * FROM `MEMBER` WHERE `pos` IN('사원','대린');
...
JOIN `MEMBER` AS b ON a.uid = b.uid
JOIN `DEPART` AS c ON b.dep = c.depNo
WHERE `sales` >= 50000 AND `sales` <=100000 AND
GROUP BY a.`uid`
HAVING `매출합` >= 100000
ORDER BY `매출합` DESC;
